    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            buttonBuilder.BuildRouteButtonToPage(
              context,
              RadialAnimationPage(),
              const Text("Radial Animation"),
            ),
            buttonBuilder.BuildRouteButtonToPage(
              context,
              LottiePage(),
            ...
            TextButton(
              ...
              onPressed: () =>
                  PageNavigator().goToWithFade(context, const FadePage()),
            ),
            TextButton(
              child: const Text("Slide Transition"),
              onPressed: () =>
                  PageNavigator().goToWithSlide(context, const SlidePage()),
            ),
            TextButton(
              child: const Text("Rotation Transition"),
              onPressed: () => PageNavigator().goToWithRotation(
                context,
                const RotationPage(),
              ),
            ),
